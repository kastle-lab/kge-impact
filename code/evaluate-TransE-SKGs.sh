...
#SBATCH --output=/home/w535axc/experiment/code/output/TransE_evaluating-SKG-4-A_%a.out  
...
singularity exec --nv dglke.sif dglke_eval \
  ...
  --gamma ${GAMMA}  > evaluate-output-6b.txt
